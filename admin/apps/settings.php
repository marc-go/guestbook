    ...
    <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
      ...
      <main class="mdl-layout__content mdl-color--grey-100">
        <div class="mdl-grid demo-content" style="display: block;">
		  ...
		  $json = json_decode(file_get_contents("bin/settings.json"));
		  
		  foreach ($json as $rule_id => $rule_n) {
			  $rule_v = $rules->getRule($rule_id) == 1 ? "checked" : "";
			  
			  echo '<label class="mdl-switch mdl-js-switch mdl-js-ripple-effect" for="' . $rule_id . '">
  						<input type="checkbox" id="' . $rule_id . '" class="mdl-switch__input" ' . $rule_v . '>
 	 					<span class="mdl-switch__label">' . $rule_n . '</span>
					</label><br><br>';
		  }
		  ?>
		  <button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--colored mdl-color-text--white" id="showMSG" onclick="save()">Speichern</button>
		</div>
