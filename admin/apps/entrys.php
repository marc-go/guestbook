...
if (!$session->checkLogin()) {
	header("Location: /admin/login.php?from=apps/entrys.php");
	exit;
}
?>
...
<html lang="de">
  <head>
    ...
    <title>Gästebuch // Admin // Einträge</title>
    ...
    <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
      <header class="demo-header mdl-layout__header mdl-color--grey-100 mdl-color-text--grey-600">
        <div class="mdl-layout__header-row">
          <span class="mdl-layout-title">Einträge</span>
      ...
      <main class="mdl-layout__content mdl-color--grey-100">
        <div class="mdl-grid demo-content" style="display: block;">
          <h1>Gästebuch // Administration</h1><br>
			<ul>
				<li><a href="#en">Freigeschaltet</a></li>
				<li><a href="#pe">Ausstehend</a></li>
				<li><a href="#bl">Gesperrt</a></li>
			</ul>
			<div id="en"></div>
		    <h2>Freigeschaltete Einträge</h2>
			<?php
			...
			if (intval($result->num_rows) == 0) {
				echo '<span>Keine Freigeschalteten Einträge.</span>';
			}
			...
			if (intval($result->num_rows) == 0) {
				echo '<span>Keine Ausstehenden Einträge.</span>';
			}
			...
			if (intval($result->num_rows) == 0) {
				echo '<span>Keine Gesperrten Einträge.</span>';
			}
