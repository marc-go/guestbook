...
if (isset($_POST["text"])) {
	...
	if (!$stmt->execute()) {
		$error = "Error to Update this Entry.";
	}else{
		header("Location: entrys.php");
		exit;
	}
}
?>
        ...
        <div class="mdl-grid demo-content" style="display: block;">
          <h1>Gästebuch // Administration</h1><br>
			...
			<form action="#" method="post">
				...
				echo '<h3>' . $row["name"] . '</h3>';
				echo '<p><b>' . $row["mail"] . '</b></p>';
				echo '
				<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
              	  <textarea class="mdl-textfield__input" id="message" rows="4" name="text" required>
				  ' . $row["text"] . '
				  </textarea><br>
                  <label class="mdl-textfield__label" for="message">Nachricht</label><br><br>
				  <button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--colored mdl-color-text--white" type="submit">Speichern</button>
                </div>';
				?>
			</form>
		</div>
